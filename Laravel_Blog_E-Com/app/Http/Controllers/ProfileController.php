    ...
    public function update(Request $request): RedirectResponse
{
    ...
    return match ($user->role) {
        'admin' => redirect()->route('admin.dashboard')->with('status', 'Name updated.'),
        'editor' => redirect()->route('editor.home')->with('status', 'Name updated.'),
        'customer' => redirect()->route('customer.dashboard')->with('status', 'Name updated.'),
        default => redirect()->route('home')->with('status', 'Name updated.'),
    };
}
