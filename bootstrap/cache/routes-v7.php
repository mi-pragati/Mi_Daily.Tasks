...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::21a4RiWEV9aGNYdN',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::AaEhPbZUgLwWtgFL',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::ZYVKZ5LVNivnSCRY',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::9aaCiFgxO5TUcgbH',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.orders.recentOrders',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      '/admin/recently-viewed/clear' => 
      array (
        0 => 
        array (
          0 => 
          array (
            '_route' => 'admin.recently-viewed.clear',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/reset\\-password/([^/]++)(*:32)|/verify\\-email/([^/]++)/([^/]++)(*:71)|/c(?|a(?|tegories/([^/]++)(*:104)|rt/(?|([^/]++)(?|(*:129))|count(*:143)))|omments/([^/]++)(?|/edit(*:177)|(*:185)))|/p(?|osts/([^/]++)(?|(*:216)|/comments(*:233))|roducts/(?|category/([^/]++)(*:270)|([^/]++)(?|(*:289)|/reviews(?|(*:308)|/([^/]++)(*:325)))))|/order(?|s/([^/]++)(?|(*:359)|/re(?|order(*:378)|turn(?|(*:393))))|/confirmation/([^/]++)(*:426))|/wishlist/([^/]++)(*:453)|/editor/(?|categories/([^/]++)(*:491)|posts/([^/]++)(?|/edit(*:521)|(*:529)))|/admin/(?|orders/([^/]++)(?|(*:567)|/(?|status(*:585)|return(*:599)))|c(?|oupons/([^/]++)(?|(*:631)|/edit(*:644)|(*:652))|ategories/([^/]++)(*:679))|p(?|osts/([^/]++)(?|/edit(*:713)|(*:721))|roduct(?|s/(?|([^/]++)(?|(*:755)|/edit(*:768)|(*:776))|category/([^/]++)(*:802))|\\-categories/([^/]++)(?|(*:835)|/edit(*:848)|(*:856)))))|/storage/(.*)(*:881))/?$}sDu',
    ),
    3 => 
    array (
      32 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:833:"function () {
                ...
                }";s:5:"scope";s:54:"Illuminate\\Foundation\\Configuration\\ApplicationBuilder";s:4:"this";N;s:4:"self";s:32:"00000000000009570000000000000000";}}',
        'as' => 'generated::21a4RiWEV9aGNYdN',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'products/{product}/reviews/{review}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\OrderController@recentOrders',
        'controller' => 'App\\Http\\Controllers\\Admin\\OrderController@recentOrders',
        'as' => 'admin.orders.recentOrders',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\OrderController@exportCsv',
        'controller' => 'App\\Http\\Controllers\\Admin\\OrderController@exportCsv',
    ...
    array (
      ...
      'uri' => 'admin/recently-viewed/clear',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    return \\redirect()->back()->with(\'status\', \'Recently viewed products cleared.\');
        ...
        'as' => 'admin.recently-viewed.clear',
      ),
      'fallback' => false,
      'defaults' => 
      array (
