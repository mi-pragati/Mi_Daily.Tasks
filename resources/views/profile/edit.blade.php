...
<div class="container py-4" style="max-width: 960px;">
  ...
  {{-- Quick nav: Home + role-based Dashboard --}}
  @auth
    @php
      $user = auth()->user();
      $dashboardRoute = match ($user->role ?? null) {
          'admin'    => route('admin.dashboard'),
          'editor'   => route('editor.home'),
          'customer' => route('customer.dashboard'),
          default    => route('home'),
      };
      $dashboardLabel = match ($user->role ?? null) {
    ...
    <div class="d-flex align-items-center gap-2 mb-3">
      <a href="{{ $dashboardRoute }}" class="btn btn-primary btn-sm">{{ $dashboardLabel }}</a>
    </div>
  @endauth
