...
<head>
  ...
  .navbar-nav .nav-link.active {
    color: #ffffff !important; /* white for active link too */
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    ...
    <div id="adnav" class="collapse navbar-collapse">
      ...
      {{-- RIGHT: Profile dropdown with actions --}}
        ...
        @auth
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item" href="{{ route('admin.categories.index') }}">Post_Categories</a></li>
              ...
              <li><a class="dropdown-item" href="{{ route('admin.categories.create') }}">Create Post Category</a></li>
              <li><a class="dropdown-item" href="{{ route('admin.products.create') }}">Create Product</a></li>
              <li><a class="dropdown-item" href="{{ route('admin.product-categories.create') }}">Create Product Category</a></li>
